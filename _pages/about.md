...
During my undergraduate years, I was part of a team that directed a national youth summit on Statistics with over 250 participants, led publicity campaigns to promote statistical literacy, and competed in data challenges that included analyzing 60,000+ urban tree records for city planning and applying machine learning techniques to health survey data. Professionally, I worked as an Operations Associate at a New York–based market research SaaS startup, where I built KPI reports, prepared datasets for product development, and contributed to SEO strategies that significantly boosted website traffic.
...
<div class="see-all-projects">
  <a href="{{ '/portfolio/' | relative_url }}">See all projects</a><span> &#10149;</span>
</div>
